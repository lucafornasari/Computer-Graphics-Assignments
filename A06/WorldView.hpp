...
glm::mat4 MakeViewProjectionMatrix(float Ar, float Alpha, float Beta, float Rho, glm::vec3 Pos) {
    ...
    glm::mat4 Mv = glm::rotate(glm::mat4(1.0), Rho, glm::vec3(0,0,1)) * glm::rotate(glm::mat4(1.0), -Beta, glm::vec3(1,0,0)) * glm::rotate(glm::mat4(1.0), -Alpha, glm::vec3(0,1,0)) * glm::translate(glm::mat4(1.0), -Pos);
    
    FovY = glm::radians(60.0f);
    glm::mat4 Mprj = glm::perspective(FovY, Ar, near_plane, far_plane);
    Mprj[1][1] *= -1;
...
glm::mat4 MakeWorldMatrix(glm::vec3 pos, glm::quat rQ, glm::vec3 size) {
    ...
    glm::mat4 rotationMatrix = glm::mat4(rQ);
    glm::mat4 translationMatrix = glm::translate(glm::mat4(1.0f), pos);
    
    glm::mat4 M = translationMatrix * rotationMatrix * scaleMatrix;
